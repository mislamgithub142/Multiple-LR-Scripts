# 1 "c:\\2025-development\\multiple-lr-scripts\\jp-10-30-2024-1-orginal-working-backup\\\\combined_JP-10-30-2024-1-Orginal-Working-Backup.c"
...
# 1 "c:\\2025-development\\multiple-lr-scripts\\jp-10-30-2024-1-orginal-working-backup\\\\combined_JP-10-30-2024-1-Orginal-Working-Backup.c" 2
...
# 2 "c:\\2025-development\\multiple-lr-scripts\\jp-10-30-2024-1-orginal-working-backup\\\\combined_JP-10-30-2024-1-Orginal-Working-Backup.c" 2
...
# 3 "c:\\2025-development\\multiple-lr-scripts\\jp-10-30-2024-1-orginal-working-backup\\\\combined_JP-10-30-2024-1-Orginal-Working-Backup.c" 2
...
# 4 "c:\\2025-development\\multiple-lr-scripts\\jp-10-30-2024-1-orginal-working-backup\\\\combined_JP-10-30-2024-1-Orginal-Working-Backup.c" 2
...
Action()
{
	...
	lr_end_transaction("01_WT_HomePage", 2);
	...
	if(icount>0)
	{	
	    lr_end_transaction("02_WT_EnterStore", 0);
	}
	 else
	 {	
	    lr_end_transaction("02_WT_EnterStore", 1);
	}
	...
	lr_end_transaction("03_WT_ClickLogin", 2);
    ...
    lr_end_transaction("04_WT_Login", 2);
	...
	lr_end_transaction("05_WT_SelectProducts", 2);
	...
	web_url("FI-SW-02", 
     ...
     lr_end_transaction("06_WT_SelectSubProducts", 2);
   ...
   lr_start_transaction("07_WT_AddtoCart");
    ...
    lr_end_transaction("07_WT_AddtoCart", 2);
	...
	lr_end_transaction("08_WT_ProceedtoCheckOut", 2);
	...
	lr_end_transaction("09_WT_ContinuewithPayment", 2);
    ...
    lr_end_transaction("10_WT_Confirm", 2);
	...
	lr_end_transaction("11_WT_SignOut", 2);


	return 0;
}
# 5 "c:\\2025-development\\multiple-lr-scripts\\jp-10-30-2024-1-orginal-working-backup\\\\combined_JP-10-30-2024-1-Orginal-Working-Backup.c" 2
...
# 6 "c:\\2025-development\\multiple-lr-scripts\\jp-10-30-2024-1-orginal-working-backup\\\\combined_JP-10-30-2024-1-Orginal-Working-Backup.c" 2
...
# 7 "c:\\2025-development\\multiple-lr-scripts\\jp-10-30-2024-1-orginal-working-backup\\\\combined_JP-10-30-2024-1-Orginal-Working-Backup.c" 2
...
# 8 "c:\\2025-development\\multiple-lr-scripts\\jp-10-30-2024-1-orginal-working-backup\\\\combined_JP-10-30-2024-1-Orginal-Working-Backup.c" 2
